const CACHE='ghost-id-v18';
const ASSETS=['./','./index.html','./manifest.webmanifest','./gameplay-v7.js','./companion-v8.js','./howto-v9.js','./gameplay-v11.js','./gameplay-v13.js','./speed-language-v14.js','./investigation-v15.js','./top-ghosts-v16.js','./remaining-ghosts-v18.js','./bootstrap-v18.js'];
...
self.addEventListener('fetch',e=>{
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request,{cache:'no-store'}).then(async r=>{
      let t=await r.text();
      t=t.replace(/<script src="\.\/bootstrap-v(?:12|15|16|17|18)\.js[^\"]*"><\/script>/g,'');
      t=t.replace('</body>','<script src="./bootstrap-v18.js?v=18"></script></body>');
