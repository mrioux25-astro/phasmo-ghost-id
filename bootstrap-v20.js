"use strict";
(() => {
  const VERSION="v20",BUILD="Gameplay QoL + Investigation Assistant";
  ...
  addVersion();
  load("./gameplay-v11.js?v=20","gameplayV11");
  load("./gameplay-v13.js?v=20","gameplayV13");
  load("./speed-language-v14.js?v=20","speedV14");
  load("./investigation-v15.js?v=20","investigationV15");
  load("./top-ghosts-v16.js?v=20","topGhostsV16");
  load("./remaining-ghosts-v18.js?v=20","remainingGhostsV18");
  load("./evidence-aware-v19.js?v=20","evidenceAwareV19");
  load("./gameplay-qol-v20.js?v=20","gameplayQolV20");
  document.documentElement.dataset.ghostBuild=VERSION;
  if("serviceWorker" in navigator){navigator.serviceWorker.register("./sw.js?v=20",{updateViaCache:"none"}).then(r=>r.update()).catch(()=>{});let reloaded=false;navigator.serviceWorker.addEventListener("controllerchange",()=>{if(reloaded||sessionStorage.getItem("ghost-v20-reload"))return;reloaded=true;sessionStorage.setItem("ghost-v20-reload","1");location.reload();});}
})();