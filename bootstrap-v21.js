"use strict";
(() => {
  const VERSION="v21.3",BUILD="Direct Interactive Maps";
  ...
  addVersion();
  load("./gameplay-v11.js?v=21.3","gameplayV11");
  load("./gameplay-v13.js?v=21.3","gameplayV13");
  load("./speed-language-v14.js?v=21.3","speedV14");
  load("./investigation-v15.js?v=21.3","investigationV15");
  load("./top-ghosts-v16.js?v=21.3","topGhostsV16");
  load("./remaining-ghosts-v18.js?v=21.3","remainingGhostsV18");
  load("./evidence-aware-v19.js?v=21.3","evidenceAwareV19");
  load("./gameplay-qol-v20.js?v=21.3","gameplayQolV20");
  load("./v21-core.js?v=21.3","v21Core");
  load("./gameplay-minor-v21.js?v=21.3","gameplayMinorV21");
  load("./map-open-v21-3.js?v=21.3","mapOpenV213");
  document.documentElement.dataset.ghostBuild=VERSION;
  if("serviceWorker" in navigator){navigator.serviceWorker.register("./sw.js?v=21.3",{updateViaCache:"none"}).then(r=>r.update()).catch(()=>{});let reloaded=false;navigator.serviceWorker.addEventListener("controllerchange",()=>{if(reloaded||sessionStorage.getItem("ghost-v21-3-reload"))return;reloaded=true;sessionStorage.setItem("ghost-v21-3-reload","1");location.reload();});}
})();
