...
(() => {
  ...
  addVersion();
  load("./gameplay-v11.js?v=18","gameplayV11");
  load("./gameplay-v13.js?v=18","gameplayV13");
  load("./speed-language-v14.js?v=18","speedV14");
  load("./investigation-v15.js?v=18","investigationV15");
  load("./top-ghosts-v16.js?v=18","topGhostsV16");
  load("./remaining-ghosts-v18.js?v=18","remainingGhostsV18");
  ...
  if("serviceWorker" in navigator){
    ...
    let reloaded=false;navigator.serviceWorker.addEventListener("controllerchange",()=>{if(reloaded||sessionStorage.getItem("ghost-v18-reload"))return;reloaded=true;sessionStorage.setItem("ghost-v18-reload","1");location.reload();});
  }
})();