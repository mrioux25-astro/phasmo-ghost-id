...
(() => {
  ...
  addVersion();
  load("./gameplay-v11.js?v=17","gameplayV11");
  load("./gameplay-v13.js?v=17","gameplayV13");
  load("./speed-language-v14.js?v=17","speedV14");
  load("./investigation-v15.js?v=17","investigationV15");
  load("./top-ghosts-v16.js?v=17","topGhostsV16");
  load("./remaining-ghosts-v17.js?v=17","remainingGhostsV17");
  document.documentElement.dataset.ghostBuild=VERSION;
  if("serviceWorker" in navigator){
    navigator.serviceWorker.register("./sw.js?v=17",{updateViaCache:"none"}).then(r=>r.update()).catch(()=>{});
    let reloaded=false;
    navigator.serviceWorker.addEventListener("controllerchange",()=>{if(reloaded||sessionStorage.getItem("ghost-v17-reload"))return;reloaded=true;sessionStorage.setItem("ghost-v17-reload","1");location.reload();});
  }
})();